        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form role="form" action="{{ route('attributes.update',$all_attributes['attribute_row_id']) }}" method="POST">
	            	@csrf
                {{ method_field('PUT') }}
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text"  class ="form-control" id="attribute_name" name="attribute_name" placeholder = "Enter Attribute Name" value="{{ $all_attributes['attribute_name'] }}">
                  </div>
                  ...
                  <div class="col-md-12 form_sec_outer_task border ">
                    ...
                    <div class="col-md-12 p-0">
                      <div class="col-md-12 form_field_outer p-0">
                        ...
                        <?php  
                          $attribute_value = json_decode($all_attributes['attribute_value'], true);
                          foreach($attribute_value as $key => $value) {
                        ?>
                            <div class="row form_field_outer_row">
                              <div class="form-group col-md-6">
                                <input type="text" class="form-control w_90" name="attribute_values[]" id="attribute_values_1" placeholder="Enter values" value="{{ $value }}" />
                              </div>
                ...
                <div class="card-footer">
                  ...
                  <input type="hidden" name="attr_id" value="{{ $all_attributes['attribute_row_id'] }}">
                </div>
              </form>
            </div>
            <!-- /.card -->
